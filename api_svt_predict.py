...
if __name__ == "__main__":
    ...
    print("\nEndpoints:")
    print("  GET  http://localhost:8002/         - Service info")
    print("  GET  http://localhost:8002/health   - Health check")
    print("  POST http://localhost:8002/predict  - Single prediction")
    print("  POST http://localhost:8002/predict/batch - Batch prediction")
    print("\nPostman test example:")
    print("  Method: POST")
    print("  URL: http://localhost:8002/predict")
