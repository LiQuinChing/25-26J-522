    ...
    <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-white/20 bg-teal-bg/95 px-10 py-3 shadow-sm backdrop-blur-md">
      ...
      <div className="flex flex-1 justify-end gap-8">
        <nav className="hidden items-center gap-9 md:flex">
          <a
            className="text-sm font-medium leading-normal text-slate-700 transition-colors hover:text-primary-dark"
            href="#analysis"
            onClick={handleAnalysisClick}
          >
            Analysis
          </a>
          <a className="text-sm font-bold leading-normal text-primary-dark" href="#knowledge-base">
            Knowledge Base
          </a>
        </nav>
