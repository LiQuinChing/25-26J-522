    ...
    <div className="bg-background-light font-display antialiased text-text-primary min-h-screen flex flex-col">
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <a className="text-sm font-medium text-text-secondary hover:text-primary transition-colors" href="#">
                Dashboard
              </a>
              <a className="text-sm font-medium text-text-secondary hover:text-primary transition-colors" href="#">
                Upload
            ...
            <div className="flex items-center gap-4">
              ...
              <div
                className="w-9 h-9 rounded-full bg-cover bg-center border-2 border-white shadow-sm cursor-pointer"
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBsM2OSpKf_0WriYNw8FWzNaEqqgZyaYbr-YZCJYtVh-Mowj8o8caebqgqGgXGDq1GWTMDBV4bRn20iiNyhi8UwD9lURXeeHvOU6MyyvwQzUnt109zRXFl2dB5sjSbYTXvin56DeEK9bsosta9DEDWS543ZDNTJfa-trx3m5vyIAQlMPVetsNZOi8pb6XnNhd9ncPPrM86_HCU8w3EZpWkhofuxpKWpQKO0BpIqxZSNRzPtl7Apj6Kh_V1w_TmiRoUJVSL-n5PMaPs')",
                }}
                title="Doctor profile portrait"
              />
            </div>
          </div>
        </div>
      ...
      <main className="flex-grow flex flex-col items-center w-full px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="w-full max-w-4xl flex flex-col items-center text-center mb-12 space-y-6">
          ...
          <div className="w-full max-w-xl relative mt-4 shadow-xl shadow-primary/10 rounded-xl">
            ...
            <input
              className="block w-full pl-11 pr-4 py-4 rounded-xl border-none ring-1 ring-black/5 focus:ring-2 focus:ring-primary bg-surface-light text-text-primary placeholder:text-text-secondary/50 text-base shadow-sm transition-all"
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <aside className="lg:col-span-3 lg:sticky lg:top-24">
            <div className="bg-surface-light rounded-xl shadow-sm border border-white/60 p-2">
            ...
            <div className="mt-6 bg-gradient-to-br from-primary to-accent-blue rounded-xl p-6 text-white shadow-lg relative overflow-hidden group">
          ...
          <div className="lg:col-span-9 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              {/* Accordion Item 1 */}
              <details className="group bg-surface-light rounded-xl border border-white/50 shadow-sm open:ring-2 open:ring-primary/20 open:shadow-md transition-all duration-300">
      ...
      <footer className="bg-surface-light border-t border-[#dcecf0] mt-auto">
        <div className="max-w-[1280px] mx-auto px-4 py-8 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-secondary text-sm">© 2024 PulseAI Diagnostics. All rights reserved.</p>
          <div className="flex gap-6">
            <a className="text-text-secondary text-sm hover:text-primary" href="#">
              Privacy Policy
            </a>
            <a className="text-text-secondary text-sm hover:text-primary" href="#">
              Terms of Service
